    ...
    <div className="scroll-mt-28 overflow-x-hidden relative max-w-screen w-screen h-screen flex flex-col">
      ...
      <div className="mt-32 mx-auto w-3/4">
        <div className="flex flex-col gap-x4">
          <Link
            href="/"
            className="w-24 my-4 rounded-md justify-center gap-x-2 py-2 px-4 bg-main/20 dark:bg-white/15 flex flex-row items-center"
          >
            {" "}
            <RiArrowGoBackFill /> <span>Zpět</span>{" "}
          </Link>
          <span className="text-3xl font-bold">Všechny projekty</span>
        </div>
