...
const ProjectsTab: React.FC = () => {
  ...
  const handleAddProject = () => {
    if (newProjectTitle) {
      const updatedProjects = [...(texts.projectData as Project[]), { title: newProjectTitle, prompts: [] }];
      setTexts({ ...texts, projectData: updatedProjects });
      setNewProjectTitle('');
    }
  };
  ...
  return (
    <div>
      <h2 className="text-4xl font-semibold text-gray-800 dark:text-gray-200 mb-8">Správa Projektů</h2>

      <div className="mb-6">
        <label htmlFor="project-select" className="block text-xl font-medium text-gray-700 dark:text-gray-300 mb-2">
          Vyber Projekt
        </label>
        <select
          id="project-select"
      ...
      {selectedProjectIndex !== null && (
        <div className="mb-8">
          <h3 className="text-2xl font-semibold text-gray-800 dark:text-gray-300 mb-4">
            Editace Projektu: {(texts.projectData as Project[])[selectedProjectIndex].title}
          </h3>

          {(texts.projectData as Project[])[selectedProjectIndex].prompts.map((prompt, index) => (
      ...
      <div className="mt-6">
        <h3 className="text-2xl font-semibold text-gray-800 dark:text-gray-300 mb-4">Přidat Nový Projekt</h3>
        <input
          type="text"
