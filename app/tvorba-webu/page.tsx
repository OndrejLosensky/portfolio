  ...
  return (
    <section className="w-3/4 space-y-12 mx-auto flex flex-col">
      ...
      <div className="text-left">
        <h2 className="text-2xl md:text-3xl lg:text-5xl mt-32 text-center text-primary font-bold">{data.webTitle}</h2>
        <p className="text-md md:text-lg lg:text-xl text-center font-light text-text-dark dark:text-text-light pt-4">
          {data.webDescription}
        </p>

        <div className="mt-24">
          <h2 className="font-semibold text-xl md:text-2xl lg:text-3xl text-text-dark/70 dark:text-text-light/70 pb-4">{data.cmsTitle}</h2>
        ...
        <div className="mt-24">
          <h2 className="font-semibold text-xl md:text-2xl lg:text-3xl text-text-dark/70 dark:text-text-light/70 pb-4">{data.handMadeTitle}</h2>
          <div className="grid grid-cols-1  lg:grid-cols-2 gap-6">
        ...
        <div className="mt-24 mb-40">
          <h2 className="font-semibold text-xl md:text-2xl lg:text-3xl text-text-dark/70 dark:text-text-light/70 pb-4">{data.graphicsTitle}</h2>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <p> {data.comingSoonText}</p>
            {/* 
