...
export default function AboutSection() {
  ...
  return (
    <div ref={ref} id="about" className="min-h-screen max-w-screen z-10 mb-64 relative w-full mx-auto flex flex-col space-y-4">
      ...
      <section className="flex flex-col lg:flex-row lg:gap-x-6 lg:items-center">
        <div className="w-full lg:w-1/3 relative lg:mt-12">
            ...
            <Image src="/profile_pic.jpeg" height={200} width={200} alt="My personal photo" className="w-2/3 hover:scale-125 duration-300 lg:w-full mx-auto rounded-xl border border-text-dark dark:border-text-light shadow-lg" />
        </div>
        ...
        <SectionTitle heading="O mě" subHeading="Kdo jsem?" />
          ...
          <p className="text-md my-2 text-green-500 font-medium pt-2 flex flex-row items-center"> <CiCircleCheck className="mr-2 w-6 h-6"/> <span>Jsem otevřen pracovním příležitostem</span></p>
      ...
      <ul className="grid grid-cols-3 lg:grid-cols-5 gap-4 mb-8">
