...
const EmailTicket: React.FC<Props> = () => {
    ...
    return (
        <div className="z-10 hidden fixed top-[45%] -left-0 lg:flex flex-col space-y-2">
            <div
            ...
            >
                <div className="pr-6">
                    <p className="font-semibold text-text-light/80 pl-2">losenskyondrej@gmail.com</p>
                </div>
            ...
            >
                <div className="pr-6">
                    <p className="font-semibold text-text-light/80 pl-2">+420 605 367 403</p>
                </div>
                <div className='group relative flex flex-row'>
