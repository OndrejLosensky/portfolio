  ...
  return (
    <section className="w-3/4 space-y-12 mx-auto flex flex-col">
      ...
      <div className="text-left">
        <h2 className="text-2xl md:text-3xl lg:text-5xl mt-32 text-center text-primary font-bold">
          {texts["webTitle"]}
        </h2>
        ...
        <div className="mt-24">
          <h2 className="font-semibold text-xl md:text-2xl lg:text-3xl text-text-dark/70 dark:text-text-light/70 pb-4">
            {texts["cmsTitle"]}
          </h2>
